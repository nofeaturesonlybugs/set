...
// TODO Original plan here was to write a PERFORMANCE-GUIDE.md detailing the cost
//      of nesting structs with multiple levels of pointer indirection.
//      These benchmarks measure both nesting and derefs and would have been used
//      in the guide as "real measures" of these design decisions in code types.
//      However I'm not sure such a guide is even warranted and -- at least for now --
//      I'm tired of waiting for these to finish when running benchmarks.
